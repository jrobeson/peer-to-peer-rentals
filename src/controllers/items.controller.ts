...
export async function searchItemsController(req: Request<{}, {}, Item, FilterQueryParams>, res: Response, next: NextFunction) {
	try {
...
export async function addItemController(
	req: Request<{}, {}, Item>,
	res: Response<{ message: string; item: Item } | { error: string }>,
	next: NextFunction
) {
	try {
		let item = req.body;
